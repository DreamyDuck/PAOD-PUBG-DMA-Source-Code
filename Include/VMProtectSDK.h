...
extern "C" {
	...
	// protection
	__inline void VMP_API VMProtectBegin(const char *) {}
	__inline void VMP_API VMProtectBeginVirtualization(const char *) {}
	__inline void VMP_API VMProtectBeginMutation(const char *) {}
	__inline void VMP_API VMProtectBeginUltra(const char *) {}
	__inline void VMP_API VMProtectBeginVirtualizationLockByKey(const char *) {}
	__inline void VMP_API VMProtectBeginUltraLockByKey(const char *) {}
	__inline void VMP_API VMProtectEnd(void) {}

	// utils
	__inline bool VMP_API VMProtectIsProtected() { return false; }
	__inline bool VMP_API VMProtectIsDebuggerPresent(bool) { return false; }
	__inline bool VMP_API VMProtectIsVirtualMachinePresent(void) { return false; }
	__inline bool VMP_API VMProtectIsValidImageCRC(void) { return true; }
	__inline const char * VMP_API VMProtectDecryptStringA(const char *value) { return value; }
	__inline const VMP_WCHAR * VMP_API VMProtectDecryptStringW(const VMP_WCHAR *value) { return value; }
	__inline bool VMP_API VMProtectFreeString(const void *value) { return true; }
#else
	// protection
...
#define VMV() VMProtectBegin(__FUNCTION__)
#define VMM() VMProtectBegin(__FUNCTION__)
#define VMU() VMProtectBegin(__FUNCTION__)
